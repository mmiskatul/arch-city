...
function getInputClass(hasError: boolean) {
  return `h-14 w-full rounded-xl border px-4 text-base text-[#111827] outline-none transition placeholder:text-[#9ca3af] ${
    hasError
      ? "border-[#ef7a80] bg-[#fff5f5] focus:border-[#df1620]"
      : "border-[#dbe0ea] bg-[#eef2f8] focus:border-[#ef242a]"
  }`;
}
  ...
  if (!isLogin && signupStep === "role") {
    return (
      <main className="min-h-screen bg-[#fafafa] px-4 py-6 sm:px-6 lg:px-8">
        <div className="mx-auto flex min-h-[calc(100vh-3rem)] max-w-7xl items-center justify-center rounded-[2rem] bg-[#f3f0ef] px-6 py-12 shadow-[0_32px_80px_rgba(15,23,42,0.08)] sm:px-10 lg:px-14">
          ...
          <div className="w-full max-w-md">
            ...
            {isLogin ? null : (
              <button
                ...
                className="mt-6 text-sm font-semibold text-[#ef242a] transition hover:text-[#c81a21]"
              >
                Change account type
              </button>
            )}
