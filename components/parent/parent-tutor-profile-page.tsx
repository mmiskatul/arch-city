...
import { PARENT_FIND_TUTORS_ROUTE, PARENT_MESSAGES_ROUTE } from "@/lib/routes";
...
export function ParentTutorProfilePage({
  tutor,
  bookingForLabel = "None selected",
  backHref = PARENT_FIND_TUTORS_ROUTE,
  bookHref,
}: {
    ...
    <ParentShell>
      <div className="w-full">
        <div className="flex items-center gap-4 border-b border-[#eceef2] bg-white px-4 py-4 sm:px-5 lg:px-6">
          <Link href={backHref} className="inline-flex items-center gap-2 text-[14px] font-medium text-[#6b7280]">
        ...
        <div className="grid bg-white lg:grid-cols-[minmax(0,1fr)_286px]">
          <section className="border-r border-[#eceef2] px-4 py-5 sm:px-5 lg:px-6">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <div className="mt-2 flex flex-wrap items-center gap-2 text-[14px] font-semibold text-[#b58112]">
                  ...
                  {typeof tutor.reviews === "number" ? <span className="text-[#6b7280]">{tutor.reviews} reviews</span> : null}
            ...
            <div className="mt-6 border-t border-[#eceef2] pt-5">
              <h3 className="text-[16px] font-bold text-[#20242b]">About {firstName}</h3>
          ...
          <aside className="px-4 py-5 sm:px-5 lg:px-5">
            <section className="rounded-[16px] bg-[#f9fafb] p-4 shadow-[0_1px_2px_rgba(15,23,42,0.04)]">
              ...
              <div className="mt-3 rounded-lg border border-[#e5e7eb] bg-white px-3 py-2 text-[13px] text-[#4b5563]">
                {bookingForLabel}
              </div>
            </section>
