...
const subRoutes = [
  {
    ...
    href: "/parent-dashboard/settings/notification-preferences",
  },
  {
    label: "Change Password",
    href: "/parent-dashboard/settings/change-password",
  },
  {
    label: "Help & FAQ's",
    href: "/parent-dashboard/settings/help-faqs",
  },
];

export function ParentSettingsSubrouteLayout({
  title,
  children,
}: {
  title: string;
  ...
  return (
    <ParentShell>
      <div className="w-full space-y-4 px-4 sm:px-5 lg:px-6">
        <div className="border-b border-[#eceef2] bg-white py-4">
