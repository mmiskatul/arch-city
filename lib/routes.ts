...
export const ADMIN_PREVIEW_ROUTE = "/admin-dashboard/preview";
...
export const STUDENT_NOTIFICATIONS_ROUTE = "/student-dashboard/notifications";
...
export const TUTOR_NOTIFICATIONS_ROUTE = "/tutor-dashboard/notifications";
...
export const PARENT_NOTIFICATIONS_ROUTE = "/parent-dashboard/notifications";
